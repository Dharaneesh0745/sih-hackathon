      ...
      <div className="bg-gradient-to-r min-h-screen flex items-center justify-center p-4 bg-gray-200">
        <div className="max-w-6xl mx-auto text-center flex flex-col items-center">
          ...
          <div className="flex flex-wrap justify-center gap-5">
            <div className="group relative bg-white shadow-2xl h-[200px] w-full max-w-xs rounded-lg p-6 hover:bg-blue-600 transition duration-500 flex flex-col items-center justify-center">
            ...
            <div className="group relative bg-white shadow-2xl h-[200px] w-full max-w-xs rounded-lg p-6 hover:bg-yellow-600 transition duration-500 flex flex-col items-center justify-center">
            ...
            <div className="group relative bg-white shadow-2xl h-[200px] w-full max-w-xs rounded-lg p-6 hover:bg-green-600 transition duration-500 flex flex-col items-center justify-center">
